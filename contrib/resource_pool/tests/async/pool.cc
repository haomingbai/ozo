...
TEST_F(async_resource_pool, asio_use_executor) {
    ...
    boost::asio::io_context callback_service;
    ...
    pool.get_auto_waste(
        ...
        boost::asio::bind_executor(
            callback_service.get_executor(),
            [call, &called](const boost::system::error_code&, async::pool<resource>::handle) {
                called = true;
                call->call();
            }
        )
